...
### Added
- **Vercel Support**: Native integration with `@vercel/rust` for serverless dashboard hosting.
...
- **Session Persistence**: Added `COOKIE_KEY` environment variable support for consistent authentication across serverless reloads.
